    ...
    <section id="contact" className="relative w-full bg-neutral-980 text-white">
      <div className="mx-auto max-w-7xl px-6 py-20">
        <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-8 text-center backdrop-blur sm:p-12">
          ...
          {submitted ? (
            <div className="mx-auto mt-8 max-w-2xl rounded-md border border-teal-400/30 bg-teal-400/10 p-4 text-teal-200">
              Thanks! Your request has been received. We’ll reach out within 1–2 business days.
            </div>
          ) : (
            <form onSubmit={onSubmit} className="mx-auto mt-8 grid max-w-2xl gap-4 sm:grid-cols-2">
              <input
                type="text"
        ...
        <div className="mt-10 text-center text-xs text-white/50">
          © {new Date().getFullYear()} Techatronix. All rights reserved.
        </div>
      </div>
    </section>
  );
